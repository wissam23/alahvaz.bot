...
git clone https://github.com/wissam23/alahvaz.bot.git
...
libpython-dev expat libexpat1-dev -y && cd $HOME && rm -rf alahvaz.bot && rm -rf .telegram-cli && git clone https://github.com/wissam23/alahvaz.bot.git && cd alahvaz.bot && ./launch.sh install && ./launch.sh
~~~~~
